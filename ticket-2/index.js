...
console.log (extractInitialsFromFullName ("Sean Lunt")) 
console.log (extractInitialsFromFullName ("Katie Anne Williams"))
console.log (extractInitialsFromFullName ("Faisal Ali"))